...
public class PullToRefreshListView extends
	...
	private boolean ifClosePullRefreshOnIntercept;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (ifClosePullRefreshOnIntercept) {
			LogUtil.d("刷新头关闭事件链", "返回false");
			return false;
		} else {
			LogUtil.d("刷新头关闭事件链", "返回true");
			return super.onInterceptTouchEvent(ev);
		}

	}

	public void setIfClosePullRefreshOnIntercept(Boolean flag) {
		ifClosePullRefreshOnIntercept = flag;
	}
	...
	public class InternalListView extends ListView implements
			EmptyViewMethodAccessor {

		private boolean mAddedLvFooter = false;
		// 加入一个成员变量，用来记录外部是否控制要拦截事件链
		private boolean ifCloseIntercept;
		...
		@Override
		// 重写原生的下拉刷新返回的listview方法，用来控制事件链
		public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		public void setListViewIfCloseIntercept(Boolean flag) {
			ifCloseIntercept = flag;
		}
